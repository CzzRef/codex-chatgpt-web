<!-- generated-from: code-note/adapters/grok.md sha256:2dabb5bd2e139effc491f0ba223de4f38e7ff14d9aa32ce5829bdf93e5c497cb -->
...
Detailed runtime and trust evidence: grok capabilities (central dependency unavailable: `adapters/grok-capabilities.md`). Rename steps: Rename Execution Path (central dependency unavailable: `adapters/grok-capabilities.md#rename-execution-path`). Configuration does not prove fresh-session acceptance; unsupported modes fall back to main-only.
