...
| Product docs | [../../docs/](../../docs/) | Upstream architecture, security, DEV chat, release validation. |
...
- Canonical product/security facts stay in `docs/` and the root README files; `vibe/knowledge/` indexes them instead of copying bodies.
