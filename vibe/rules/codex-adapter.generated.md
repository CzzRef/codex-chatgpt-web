<!-- generated-from: code-note/codex-evolution/README.md sha256:f556e0b46e8c2064b3e80764e190a7501ebb3a8912b1509a278b82a7c9e0965c -->
...
For task naming, execute the native task title route (central dependency unavailable: `codex-evolution/host-capabilities.md#native-task-title-route`); a `rename-supported` manifest row alone is not execution.

## Residual Gate Index

State: current-state (central dependency unavailable: `governance/current-state.json#L1`); acceptance: rollout (central dependency unavailable: `codex-evolution/rollout/README.md`). Hooks fail open; keep existing action gates.
